...
const Categories = ({className}: {className?: string}) => {
  return (
    <section className={`container grid grid-cols-1  md:grid-cols-3 gap-[64px] md:gap-2.5 lg:gap-[30px] ${className}`} >
      <div id="cat1" className="bg-[#f1f1f1] rounded-lg h-[165px] lg:h-[204px] relative ">
      ...
      <div id="cat2" className="bg-[#f1f1f1] rounded-lg h-[165px] lg:h-[204px] relative">
      ...
      <div id="cat3" className="bg-[#f1f1f1] rounded-lg h-[165px] lg:h-[204px] relative">
